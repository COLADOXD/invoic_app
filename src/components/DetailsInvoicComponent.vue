...
<template>
    <div class="p-5 bg-white rounded-lg pb-7 dark:bg-secondary border-slate-300 border dark:border-0">
        <p class=" font-semibold text-lg"><span class="text-blue-500">#</span>RT3080</p>
        ...
        <div class="flex mb-7 text-lg">
            <div class="w-1/2">
                ...
                <p class="font-bold text-xl mb-10">21 Aug 2021</p>
                <p class="text-slate-400">Payment Due</p>
                <p class="font-bold text-xl">20 Sep 2021</p>
            </div>
            <div class="text-slate-400 w-1/2">
                <p>Bill To</p>
                <p class="font-bold text-xl text-black dark:text-white">Alex Grim</p>
                <p>84 Church Way</p>
                <p>Bradford</p>
                <p>BD1 9PB</p>
                <p>United Kingdom</p>
